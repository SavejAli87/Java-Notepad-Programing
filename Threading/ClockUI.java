...
public class ClockUI extends JPanel implements Runnable
{
	...
	Date cd;
	int xOrigin = 375,yOrigin = 375,xsec,ysec,xmin,xhr,yhr,ymin;
	...
	// String Written Text
	g.setColor(Color.blue);
	g.drawString("Clock Design By MR....=>  Savej ali " ,300,100);
	g.drawString("Under THE Guidence Of" ,180,150);
	g.setColor(Color.black);
	g.setFont(new Font("TimesRoman", Font.BOLD,35));
	g.drawString("MR Manish Bhatia Sir" ,530,150);
	//uper section by junaid 
...
public void paint(Graphics g){
  ...
  // value for coordinates and vector Forms
